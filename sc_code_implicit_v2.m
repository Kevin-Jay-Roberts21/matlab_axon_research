% Solving the Single Cable Model Using Finite Difference Method Version 2
% Kevin Roberts
% November 2024
...
N_0 = 0.4263; % (#) initial condition for gating variable n
M_0 = 0.1148; % (#) initial condition for gating variable m
H_0 = 0.3549; % (#) initial condition for gating variable h
Vm = V_m0 * ones(1, m);
Vmy = zeros(1, m);
N = zeros(1, m);
M = zeros(1, m);
