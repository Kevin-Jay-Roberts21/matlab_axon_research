...
list_of_data = {HH_S_12, HH_S_11_5, HH_S_11_41, HH_S_11_406, HH_S_11_4055, HH_S_11_40546, HH_S_11_405456, HH_S_11_4054556, HH_S_11_40545555, HH_S_11_405455545, HH_S_11_4054555448};

% creating the stimulus grid
stim_grid = [12, 11.5, 11.41, 11.406, 11.4055, 11.40546, 11.405456, 11.4054556, 11.40545555, 11.405455545, 11.4054555448];
...
threshold = min(stim_grid);
delta_stim = stim_grid - threshold;
