...
E_rest = -67.7292; % (mV) effective resting nernst potential
...
N_0 = 0.2768; % (#) initial condition for gating variable n
M_0 = 0.0382; % (#) initial condition for gating variable m
H_0 = 0.6873; % (#) initial condition for gating variable h
Vm = V_m0 * ones(1, m);
Vmy = V_my0 * ones(1, m);
N = zeros(1, m);
M = zeros(1, m);
...
% save('DC_Huang_Myelinated_set_higher_stim1_rpn_100fold.mat');