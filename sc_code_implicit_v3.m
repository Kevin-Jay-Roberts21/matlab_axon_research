...
% Initialization
%%%%%%%%%%%%%%%%
V_m0 = -58.1124;%-67.7292; %-29.7806; % (mV) initial condition for membrane potential 
V_my0 = 1.2334; %-6.8577 %1.2; % (mV) initial condition for axon potential in periaxonal space
N_0 = 0.4264;%0.2768; %0.7731;% (dimless) initial condition for gating variable n
M_0 = 0.1148;%0.0382; %0.7385;% (dimless) initial condition for gating variable m
H_0 = 0.3548;%0.6873; %0.0188;% (dimless) initial condition for gating variable h
Vm = V_m0 * ones(1, m);
Vmy = zeros(1, m);
N = zeros(1, m);
M = zeros(1, m);
