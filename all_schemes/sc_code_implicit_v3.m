...
% a_my = a + (a_my - a)*lambda_d; % tilde(a)_my
a_my = 0.5*(a + a_my); % this is bar(a)_my (where a_my on the inside is tilde_a_my when simulating demyelination)
...
% Initialization
%%%%%%%%%%%%%%%%
V_m0 = -58.1547; % (mV) initial condition for membrane potential 
V_my0 = 0.8212; % (mV) initial condition for axon potential in periaxonal space
...
% save('SC_Cohen_set2_demyelination05.mat'); 